  ...
  return (
    <motion.div
      ...
      className={[
        ...
        "shadow-[0_10px_30px_rgba(0,44,90,0.04)]",
        isOpen ? "bg-[#00D4FF1A]" : "bg-white hover:bg-[#00D4FF0D]",
      ].join(" ")}
    >
      <button
        type="button"
      ...
      >
        <span className="text-[#002C5A] font-extrabold text-base md:text-lg">
          {item.question}
        </span>
        ...
        <div
          className={[
            ...
            isOpen ? "rotate-180 text-[#002C5A]" : "text-[#767676]",
          ].join(" ")}
        >
      ...
      <div
        className={`grid transition-all duration-300 ease-in-out overflow-hidden ${
          isOpen ? "grid-rows-[1fr] opacity-100 pb-6 px-6 md:px-8" : "grid-rows-[0fr] opacity-0"
        }`}
      >
        <div className="overflow-hidden">
          <p className="text-[#767676] text-sm md:text-[15px] leading-relaxed border-t border-gray-200/60 pt-4">
            {item.answer}
          </p>
        </div>
      </div>

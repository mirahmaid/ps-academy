...
function ContactSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto mt-6 max-w-6xl rounded-[32px] border-[3px] border-[#00D4FF]/30 bg-white px-6 pb-10 pt-8 sm:px-14 sm:pb-14 sm:pt-10">
        <h2 className="contact-title absolute left-1/2 top-0 -translate-x-1/2 -translate-y-1/2 whitespace-nowrap bg-white px-4 text-base font-bold text-[#002C5A] sm:text-2xl">
          فريقنا جاهز للرد على أسئلتكم
        </h2>

        <p className="contact-cta mb-8 text-center text-xl font-bold text-[#38B793] sm:mb-10 sm:text-xl">
          تواصلوا معنا الآن
        </p>
